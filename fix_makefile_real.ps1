# Script PowerShell pour corriger le Makefile avec les vrais fichiers

param(
    [string]$Architecture = "x86_64"
)

Write-Host "🔧 Correction du Makefile avec les vrais fichiers..." -ForegroundColor Green
...
Write-Host "📝 Correction des sources avec les vrais fichiers..." -ForegroundColor Yellow

# Supprimer les références aux fichiers inexistants
$content = $content -replace "SOURCES \+= src/fds\.c", "# SOURCES += src/fds.c # Fichier inexistant"
