# Script pour compiler un core minimal et stable
param(
    [string]$Architecture = "arm64-v8a"
)

Write-Host "🔨 Compilation d'un core minimal et stable pour $Architecture..." -ForegroundColor Green

# Configuration
$NDK_PATH = "C:\Users\Quentin\AppData\Local\Android\Sdk\ndk\28.2.13676358"
$BUILD_DIR = "minimal_core_build"
...
$SOURCE_FILE = "minimal_core.c"
Set-Content $SOURCE_FILE $MINIMAL_CORE -Encoding UTF8
...
# Compiler le core minimal
Write-Host "🔨 Compilation du core minimal..." -ForegroundColor Yellow

$COMPILE_CMD = "$CC $CFLAGS -I. -c $SOURCE_FILE -o minimal_core.o"
...
if ($LASTEXITCODE -eq 0) {
    ...
    # Lier le core
    $LINK_CMD = "$CC $LDFLAGS minimal_core.o -o fceumm_libretro_android.so"
