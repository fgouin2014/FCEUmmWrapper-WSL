# Script PowerShell pour tester la compilation d'un core minimal

param(
    [string]$Architecture = "x86_64"
)

Write-Host "🧪 Test de compilation d'un core minimal..." -ForegroundColor Green
...
try {
    Invoke-Expression $COMPILE_COMMAND
