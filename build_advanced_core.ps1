# Script pour compiler un core avancé avec affichage et chargement de ROMs
param(
    [string]$Architecture = "arm64-v8a"
)

Write-Host "🔨 Compilation d'un core avancé pour $Architecture..." -ForegroundColor Green

# Configuration
$NDK_PATH = "C:\Users\Quentin\AppData\Local\Android\Sdk\ndk\28.2.13676358"
$BUILD_DIR = "advanced_core_build"
...
# Créer un core avancé avec affichage et chargement de ROMs
$ADVANCED_CORE = @"
#include <libretro.h>
#include <stdlib.h>
#include <string.h>
...
$SOURCE_FILE = "advanced_core.c"
Set-Content $SOURCE_FILE $ADVANCED_CORE -Encoding UTF8
...
# Compiler le core avancé
Write-Host "🔨 Compilation du core avancé..." -ForegroundColor Yellow

$COMPILE_CMD = "$CC $CFLAGS -I. -c $SOURCE_FILE -o advanced_core.o"
...
if ($LASTEXITCODE -eq 0) {
    ...
    # Lier le core
    $LINK_CMD = "$CC $LDFLAGS advanced_core.o -o fceumm_libretro_android.so"
    ...
    if ($LASTEXITCODE -eq 0) {
        ...
        Write-Host "🎉 Core avancé compilé avec succès!" -ForegroundColor Green
    } else {
